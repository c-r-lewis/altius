                ...
                <ul class="navbar-nav mb-0 d-flex flex-row">
                    ...
                    <li class="nav-item">
                        <a class="nav-link px-1" role="button" data-bs-toggle="modal" data-bs-target="#popupCreate">
                            <svg width="25" height="25" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown"
                           aria-expanded="false">
                            <svg width="25" height="25" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-1" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="?controleur=friends&action=afficherPageDemandeAmis">Mes Demandes d'Amis</a></li>
                        </ul>
                    </li>
                    <?php endif;
