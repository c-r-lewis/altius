...
foreach ($messagesFlash as $type1 => $messagesFlashPourUnType1):
    if (sizeof($messagesFlashPourUnType1) != 0):?>
        <div class="container" style="margin-top: 88px">
            <?php foreach ($messagesFlash as $type => $messagesFlashPourUnType) {
        ...
        <div class="modal-content">
            <div class="card">
                <div class="card-header d-flex justify-content-center" id="newPublicationTitle">
                    ...
                    <input class="link-primary btn p-0 ms-5" type="submit" id="submitBtn" value="Créer"
                           style="display: none;">
                    <button class="link-primary btn p-0 ms-5" id="nextBtn" style="display: none;"
                            onclick="addDescriptionToEvent()">Suivant
                    </button>
                </div>
