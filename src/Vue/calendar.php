...
<div>
    ...
    <?php foreach ($data as $index => $event): ?>
        ...
        <!-- Modal -->
        <div class="modal fade" id="<?=$event["publicationID"]?>" tabindex="-1" aria-labelledby="eventModalLabel<?= $index ?>" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="<?=$event["publicationID"]?>"><?= htmlspecialchars($event['title']) ?></h5>
                                    ...
                                    <div class="card-body px-1">
                                        ...
                                        <div class="row">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ps-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                         class="bi bi-share" viewBox="0 0 16 16" id="shareButton">
