...
<div class="container-fluid">
    <div class="row position-relative">
        <div id="carouselDiv" class="row">
            <!-- Go left button -->
            <div class="col-1 d-flex align-items-center pe-0">
                <svg xmlns="http://www.w3.org/2000/svg" id="leftButtonCreate" width="16" height="16" fill="currentColor" class="bi bi-chevron-left d-none" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0"/>
                </svg>
            </div>
            <div class="col-10 justify-content-center d-flex position-relative my-3 p-0" id="imgContainer">
                <!-- Images will be added here dynamically -->
                <div class="carousel-image" id="slide1">

                </div>
            </div>
            <!-- Go right button -->
            <div class="col-1 ps-0 d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" id="rightButtonCreate" width="16" height="16" fill="currentColor" class="bi bi-chevron-right d-none" viewBox="0 0 16 16">
